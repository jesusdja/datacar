...
import 'package:datacar/pages/categories/models/categories_model.dart';
import 'package:datacar/pages/categories/provider/categories_provider.dart';
import 'package:datacar/pages/categories/provider/firebase_connection_categories.dart';
...
import 'package:datacar/widgets_utils/textfield_general.dart';
      ...
      child: Row(
        children: [
          ...
          ButtonGeneral(
            ...
            height: sizeH * 0.06,
            title: 'Agregar',
            textStyle: DataCarStyles().stylePrimary(size: sizeH * 0.02,color: Colors.white),
  ...
  Widget cardCategory({required CategoriesModel categoriesModel}){
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text(categoriesModel.name!,style: DataCarStyles().stylePrimary(
              size: sizeH * 0.025,fontWeight: FontWeight.bold
            )),
          ),
          ButtonGeneral(
            title: isInactivo ? 'Activar' : 'Desactivar',
            textStyle: DataCarStyles().stylePrimary(size: sizeH * 0.015,color: Colors.white),
